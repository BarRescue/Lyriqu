package com.lyriqu.payment.rabbitmq;
...
public class DirectConfiguration {
    ...
    public Queue createCustomerQueue() {
        return new Queue("createdCustomer", true);
    }
    ...
    public Binding createCustomerBinding(Queue createCustomerQueue, DirectExchange exchange) {
        return BindingBuilder.bind(createCustomerQueue).to(exchange).with("created-customer");
    }
